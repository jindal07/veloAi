    ...
    return (
      ...
      >
        <div className="my-7 w-full">
          <div className="w-13 h-13 bg-gray-200 rounded-full mx-auto animate-pulse"></div>
          <div className="mt-1 h-4 bg-gray-200 rounded mx-auto w-24 animate-pulse"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="my-7 w-full">
        ...
        <div className="mt-5 text-sm text-gray-600 font-medium px-6">
