...
export const generateArticle = async (req, res) => {
  try {
    ...
    res.json({ success: true, message: content }); //added message
  } catch (error) {
    console.log(error);
...
export const removeImageBackground = async (req, res) => {
  try {
    ...
    await sql`INSERT INTO creations (user_id,prompt,content,type) VALUES(${userId},'Remove the background from the image',${secure_url},'image')`;
...
export const resumeReview = async (req, res) => {
  try {
    ...
    const prompt=`Review the following resume and provide constructive feedback on its strengths, weaknesses, and area of improvements.Make no mistake. Resume content:\n\n ${pdfData.text}`
